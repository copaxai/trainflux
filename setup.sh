...
if [ ! -f "xplus2_base.safetensors" ]; then
...
echo "---------- start kohya"
cd /workspace/kohya_ss
for MODEL in "/workspace/models/t5xxl_fp16.safetensors" "/workspace/models/clip_l.safetensors" "/workspace/models/ae.safetensors" "/workspace/models/xplus2_base.safetensors"; do
    if [ -f "${MODEL}" ]; then
